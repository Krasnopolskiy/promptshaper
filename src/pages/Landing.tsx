...
const Landing = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-background">
            ...
            >
                <div
                    className={`max-w-6xl mx-auto transition-all duration-1000 ${isVisible.hero ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
                        ...
                        <div className="flex-1 relative">
                            <div
                                className="relative z-10 bg-white dark:bg-background backdrop-blur-none rounded-2xl shadow-xl border border-border/50 overflow-hidden">
                                ...
                                <div className="p-6">
                                    ...
                                    <div
                                        className="p-3 rounded-md bg-background/50 border border-border/50 text-sm mb-4">
                                        Write a compelling ad for <span
                                        className="inline-block px-1.5 py-0.5 rounded text-xs font-medium bg-blue-100 dark:bg-blue-800/70 text-blue-800 dark:text-blue-200 dark:shadow-[0_0_10px_rgba(59,130,246,0.3)]">{"<company>"}</span> promoting
                                        their <span
                                        className="inline-block px-1.5 py-0.5 rounded text-xs font-medium bg-purple-100 dark:bg-purple-800/70 text-purple-800 dark:text-purple-200 dark:shadow-[0_0_10px_rgba(168,85,247,0.3)]">{"<product>"}</span> to <span
                                        className="inline-block px-1.5 py-0.5 rounded text-xs font-medium bg-amber-100 dark:bg-amber-800/70 text-amber-800 dark:text-amber-200 dark:shadow-[0_0_10px_rgba(245,158,11,0.3)]">{"<audience>"}</span>
                                    </div>
                                    ...
                                    <div
                                        className="p-3 rounded-md bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-900/50 text-sm">
            ...
            >
                <div
                    className={`max-w-6xl mx-auto transition-all duration-1000 ${isVisible.features ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            >
                <div
                    className={`max-w-6xl mx-auto transition-all duration-1000 ${isVisible.workflow ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    <div className="text-center mb-16">
                    ...
                    <div className="relative">
                        ...
                        <div className="flex flex-col md:flex-row items-center mb-16 md:mb-24">
                            ...
                            <div className="relative flex-shrink-0">
                                <div
                                    className="h-16 w-16 rounded-full bg-white dark:bg-background shadow-lg border border-blue-100 dark:border-blue-900/50 flex items-center justify-center z-10 relative">
                            ...
                            <div className="md:w-1/2 md:pl-12 mt-8 md:mt-0">
                                <div
                                    className="bg-white dark:bg-background p-6 rounded-lg shadow-md border border-blue-100 dark:border-blue-900/50">
                                    <div className="flex flex-wrap gap-2">
                                        <div
                                            className="inline-block px-3 py-1 rounded-full text-sm font-medium bg-indigo-100 dark:bg-indigo-800/70 text-indigo-800 dark:text-indigo-200 dark:shadow-[0_0_10px_rgba(99,102,241,0.3)]">{"<company>"}</div>
                                        <div
                                            className="inline-block px-3 py-1 rounded-full text-sm font-medium bg-purple-100 dark:bg-purple-800/70 text-purple-800 dark:text-purple-200 dark:shadow-[0_0_10px_rgba(168,85,247,0.3)]">{"<product>"}</div>
                                        <div
                                            className="inline-block px-3 py-1 rounded-full text-sm font-medium bg-orange-100 dark:bg-orange-800/70 text-orange-800 dark:text-orange-200 dark:shadow-[0_0_10px_rgba(249,115,22,0.3)]">{"<audience>"}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="md:w-1/2 md:pr-12 md:text-right mb-8 md:mb-0 md:order-1 order-2">
                                <div
                                    ...
                                    <p className="text-base">
                                        Write a compelling ad for <span
                                        className="inline-block px-2 py-0.5 rounded text-xs font-medium bg-indigo-100 dark:bg-indigo-800/70 text-indigo-800 dark:text-indigo-200 dark:shadow-[0_0_10px_rgba(99,102,241,0.3)]">{"<company>"}</span> promoting
                                        their <span
                                        className="inline-block px-2 py-0.5 rounded text-xs font-medium bg-purple-100 dark:bg-purple-800/70 text-purple-800 dark:text-purple-200 dark:shadow-[0_0_10px_rgba(168,85,247,0.3)]">{"<product>"}</span> to <span
                                        className="inline-block px-2 py-0.5 rounded text-xs font-medium bg-orange-100 dark:bg-orange-800/70 text-orange-800 dark:text-orange-200 dark:shadow-[0_0_10px_rgba(249,115,22,0.3)]">{"<audience>"}</span>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="md:w-1/2 md:pl-12 mt-8 md:mt-0">
                                <div
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex items-center">
                                            <div
                                                className="w-24 text-sm text-right text-muted-foreground mr-4">company:
                                            </div>
                                            <div className="text-base font-medium">Acme Inc</div>
                                        </div>
                                        <div className="flex items-center">
                                            <div
                                                className="w-24 text-sm text-right text-muted-foreground mr-4">product:
                                            </div>
                                            <div className="text-base font-medium">Smart Home Hub</div>
                                        </div>
                                        <div className="flex items-center">
                                            <div
                                                className="w-24 text-sm text-right text-muted-foreground mr-4">audience:
                                            </div>
                        ...
                        <div className="flex flex-col md:flex-row items-center">
                            <div className="md:w-1/2 md:pr-12 md:text-right mb-8 md:mb-0 md:order-1 order-2">
                                <div
                                    className="bg-white dark:bg-background p-6 rounded-lg shadow-md border border-blue-100 dark:border-blue-900/50">
                                    <div
                                        className="bg-green-50 dark:bg-green-900/30 p-3 rounded border border-green-100 dark:border-green-900/50 text-base">
                                        Write a compelling ad for Acme Inc promoting their Smart Home Hub to tech
                                        enthusiasts.
                                    </div>
                                </div>
            ...
            >
                <div
                    className={`max-w-4xl mx-auto transition-all duration-1000 ${isVisible.cta ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    <div
                        className="bg-gradient-to-r from-primary/90 to-primary rounded-2xl p-8 md:p-12 text-white text-center shadow-xl">
