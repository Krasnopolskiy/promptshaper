        ...
        <div className="flex flex-col min-h-screen">
            ...
            {showWelcome && (
                <div
                    ...
                    <div
                        className="max-w-2xl p-8 rounded-2xl bg-white dark:bg-background shadow-2xl border border-border/50 animate-enter-active">
                        ...
                        <p className="text-muted-foreground text-center mb-8">
                            Welcome to Prompt Shaper! Create reusable prompt templates with placeholders to generate
                            consistent AI prompts.
                        </p>

                        <div className="grid grid-cols-3 gap-4 mb-8">
                            <div
                                className="p-4 rounded-lg bg-accent/20 dark:bg-accent/10 flex flex-col items-center text-center">
                                <Layers className="h-6 w-6 text-primary mb-2"/>
                                <h3 className="font-medium">Create Placeholders</h3>
                                <p className="text-sm text-muted-foreground">Define reusable variables for your
                                    prompts</p>
                            </div>
                            <div
                                className="p-4 rounded-lg bg-accent/20 dark:bg-accent/10 flex flex-col items-center text-center">
                                ...
                                <p className="text-sm text-muted-foreground">Design prompt templates with
                                    placeholders</p>
                            </div>
                            <div
                                className="p-4 rounded-lg bg-accent/20 dark:bg-accent/10 flex flex-col items-center text-center">
            ...
            {isMobile ? (
                <div className="flex-1 flex flex-col overflow-hidden p-4 max-w-full">
                    <div
                        className="flex border-b border-border rounded-t-lg overflow-hidden bg-white/70 dark:bg-background/70 backdrop-blur-sm shadow-sm">
                        <button
                ...
                <div className="flex-1 p-4 overflow-hidden">
                    <div className="flex flex-col lg:flex-row gap-4 h-[calc(100vh-120px)]">
                        <div
                            className="w-full lg:w-80 h-full flex-shrink-0 shadow-lg rounded-lg overflow-hidden bg-white/70 dark:bg-background/70 backdrop-blur-sm border border-border/50 transition-all duration-300 hover:shadow-xl">
                            <PlaceholderPanel
                                placeholders={placeholders}
                                onAddPlaceholder={addPlaceholder}
                                onUpdatePlaceholder={updatePlaceholder}
                        ...
                        <div
                            className="w-full lg:flex-1 h-full shadow-lg rounded-lg overflow-hidden bg-white/70 dark:bg-background/70 backdrop-blur-sm border border-border/50 transition-all duration-300 hover:shadow-xl">
                            <EditorPanel
                                promptText={promptText}
                                setPromptText={setPromptText}
                                placeholders={placeholders}
